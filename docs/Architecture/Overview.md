...
flowchart LR
    ...
    McpServerExport --> SdkCore["SDK 2.0 discovery, cache hints, protocol metadata"]
...
- [`docs/ADR/ADR-0014-mcp-sdk-2-protocol-and-extension-adoption.md`](../ADR/ADR-0014-mcp-sdk-2-protocol-and-extension-adoption.md): documents the current-only SDK 2.0 protocol, Streamable HTTP, per-request subscriptions, Tasks, MCP Apps, arbitrary output schemas, and Markdown-LD `0.2.8` adoption.
