...
public sealed partial class McpGatewayTokenizerSearchEvaluationTests
{
    ...
    public async Task SearchAsync_TokenizerSearchMeetsEvaluationThresholds()
    {
        foreach (var tokenizer in Enum.GetValues<McpGatewayTokenSearchTokenizer>())
        {
            ...
            Console.WriteLine(
                $"{tokenizer} / high-relevance: top1={highRelevanceMetrics.Top1Accuracy:P2}; top3={highRelevanceMetrics.Top3Accuracy:P2}; top5={highRelevanceMetrics.Top5Accuracy:P2}; mrr={highRelevanceMetrics.MeanReciprocalRank:F2}");
            Console.WriteLine(
                $"{tokenizer} / borderline: top1={borderlineMetrics.Top1Accuracy:P2}; top3={borderlineMetrics.Top3Accuracy:P2}; top5={borderlineMetrics.Top5Accuracy:P2}; mrr={borderlineMetrics.MeanReciprocalRank:F2}");
            Console.WriteLine(
                $"{tokenizer} / multilingual: top1={multilingualMetrics.Top1Accuracy:P2}; top3={multilingualMetrics.Top3Accuracy:P2}; top5={multilingualMetrics.Top5Accuracy:P2}; mrr={multilingualMetrics.MeanReciprocalRank:F2}");
            Console.WriteLine(
                $"{tokenizer} / typo: top1={typoMetrics.Top1Accuracy:P2}; top3={typoMetrics.Top3Accuracy:P2}; top5={typoMetrics.Top5Accuracy:P2}; mrr={typoMetrics.MeanReciprocalRank:F2}");
            Console.WriteLine(
                $"{tokenizer} / weak-intent: top1={weakIntentMetrics.Top1Accuracy:P2}; top3={weakIntentMetrics.Top3Accuracy:P2}; top5={weakIntentMetrics.Top5Accuracy:P2}; mrr={weakIntentMetrics.MeanReciprocalRank:F2}");
            Console.WriteLine(
                $"{tokenizer} / irrelevant: low-confidence={irrelevantMetrics.LowConfidenceRate:P2}; avg-top-score={irrelevantMetrics.AverageTopScore:F2}");
