...
)
{
    ...
    )
    {
        ...
        {
            Tools = descriptors.Select(ToProtocolTool).ToList(),
        };
    }
    ...
    )
    {
        ...
        {
            Prompts = descriptors.Select(ToProtocolPrompt).ToList(),
        };
    }
        ...
        if (message.Content is not null)
        {
            try
            {
                ...
                if (content is not null)
                {
                    ...
                    {
                        Role = Enum.TryParse<Role>(message.Role, ignoreCase: true, out var parsedRole)
                            ? parsedRole
                            : Role.User,
                        Content = content,
                    };
