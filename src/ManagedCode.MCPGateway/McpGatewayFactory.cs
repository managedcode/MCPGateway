...
public sealed class McpGatewayFactory(IServiceProvider serviceProvider, ILoggerFactory loggerFactory)
    : IMcpGatewayFactory
{
    ...
    public IMcpGatewayInstance Create(McpGatewayOptions options)
    {
        ...
        var runtimeServiceProvider = new McpGatewayFactoryServiceProvider(serviceProvider, registry);
